    ...
    if(questions != null){
            ...
            var questionHtml = `
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" class="form-control" id="image-input" name="image-input" placeholder="Link ảnh" value = "${questions.image.link ? questions.image.link : ''}">
                    </div>
            ...
            if(questions.image.nameBase64){
                labelImage.textContent = questions.image.nameBase64;
            }else {
