package com.example.do_an_toeic.service.firebase;
...
public class ImageUploadServiceImp implements ImageUploadService {
    ...
    public String uploadFile(File file, String fileName) throws IOException {
        ...
        String fileNameEnd = file.getName();
        String contentType;
        if (fileNameEnd.endsWith(".jpg") || fileNameEnd.endsWith(".jpeg")) {
            contentType = "image/jpeg";
        } else if (fileNameEnd.endsWith(".mp3")) {
            contentType = "audio/mpeg";
        } else if (fileNameEnd.endsWith(".png")){
