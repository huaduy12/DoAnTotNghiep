...
public class ImportQuestionServiceImpl implements ImportQuestionService{
    ...
    /**
     * import câu hỏi vào quản lý câu hỏi
     * @param multipartFile
     * @return
     * @throws IOException
     */
    ...
    public void saveQuestionFilePhoto(PhotoDto photoDto){
        ...
        if(!CommonUtils.isEmptyOrNull(photoDto.getLevel())){
    ...
    public void saveQuestionFileShortTalk(List<ShortTalkDto> shortTalkDtos, String typeSkill){
        for (ShortTalkDto shortTalkDto: shortTalkDtos) {
            ...
            if (!CommonUtils.isEmptyOrNull(shortTalkDto.getLevel())) {
    ...
    @Override
    public Integer importFileQuestionForExam(MultipartFile multipartFile, Integer examId) throws IOException {
        Integer result = -1;
        Workbook workbook = WorkbookFactory.create(multipartFile.getInputStream());
            ...
            switch (i) {
                case 0:
                    ...
                    try {
                        for (Row row : sheet) {
                            ...
                            photoDto.setTypeQuestion((int) Double.parseDouble(getCellValue(row.getCell(5))));
                            photoDto.setLevel(getCellValue(row.getCell(6)));
                            saveQuestionFilePhotoExam(photoDto,examId);
                ...
                case 1:
                    ...
                    try {
                        for (Row row : sheet) {
                            ...
                            saveQuestionFileQuestionReponseExam(photoDto,examId);
                ...
                case 2:
                    ...
                    try {
                        for (Row row : sheet) {
                            ...
                            saveQuestionFileSortConversationExam(photoDto,examId);
                ...
                case 3:
                    ...
                    try {
                        ...
                        saveQuestionFileShortTalkExam(shortTalkDtos, TypeExercise.SHORT_TALK.getValue(),examId);
                    } catch (Exception e) {
                        result = 4;
                        throw new RuntimeException("Lỗi import");
                    }
                ...
                case 4:
                    ...
                    try {
                        for (Row row : sheet) {
                            ...
                            photoDto.setTypeQuestion((int) Double.parseDouble(getCellValue(row.getCell(4))));
                            photoDto.setLevel(getCellValue(row.getCell(5)));
                            saveQuestionFileTextCompletionExam(photoDto,examId);
                        }
                    } catch (Exception e) {
                        result = 5;
                        throw new RuntimeException("Lỗi import");
                ...
                case 5:
                    ...
                    try {
                        ...
                        saveQuestionFileShortTalkExam(textCompletionDtos, TypeExercise.TEXT_COMPLETION.getValue(),examId);
                    } catch (Exception e) {
                        result = 6;
                        throw new RuntimeException("Lỗi import");
                    }
                ...
                case 6:
                    try {
                        ...
                        saveQuestionFileShortTalkExam(singlePassages, TypeExercise.SINGLE_PASSAGE.getValue(),examId);
                    } catch (Exception e) {
                        result = 7;
                        throw new RuntimeException("Lỗi import");
                    }
    ...
    public void saveQuestionFilePhotoExam(PhotoDto photoDto, Integer examId){
        Question question = new Question();
        question.setName(photoDto.getName());
        question.setIndexCorrect(photoDto.getIndexCorrect());
        question.setTypeQuestion(photoDto.getTypeQuestion());
        ...
        examQuestion.setQuestionId(questionSave.getId());
    ...
    public void saveQuestionFileQuestionReponseExam(PhotoDto photoDto, Integer examID){
        Question question = new Question();
        question.setName(photoDto.getName());
        question.setIndexCorrect(photoDto.getIndexCorrect());
        question.setTypeQuestion(photoDto.getTypeQuestion());
    ...
    public void saveQuestionFileSortConversationExam(PhotoDto photoDto, Integer examId){
        Question question = new Question();
        question.setName(photoDto.getName());
        question.setDescription(photoDto.getDescription());
        question.setIndexCorrect(photoDto.getIndexCorrect());
    ...
    public void saveQuestionFileTextCompletionExam(PhotoDto photoDto, Integer examId){
        Question question = new Question();
        question.setName(photoDto.getName());
        question.setDescription(photoDto.getDescription());
        question.setIndexCorrect(photoDto.getIndexCorrect());
    ...
    public void saveQuestionFileShortTalkExam(List<ShortTalkDto> shortTalkDtos, String typeSkill, Integer examId){
        for (ShortTalkDto shortTalkDto: shortTalkDtos) {
            Question questionParent = new Question();
            questionParent.setName(shortTalkDto.getName());
            questionParent.setDescription(shortTalkDto.getDescription());
            ...
            ExamQuestion examQuestion = new ExamQuestion();
            examQuestion.setQuestionId(questionParentSave.getId());
            examQuestion.setExamId(examId);
            examQuestionRepository.save(examQuestion);
