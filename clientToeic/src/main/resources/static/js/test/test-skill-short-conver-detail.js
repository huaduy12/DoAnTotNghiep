    ...
    data: [
        {
            ...
            description:"M: Ms. Martin, I really think that the photos from the weekend rugby match should be included in this weekend's sports section. W: Our readers prefer golf and football, so I usually include those sports instead. M: I understand, but we need to differentiate ourselves from other papers. Why don't we try offering something different? W: I don't think many at our readers are rugby fans, but I'll talk it over with Josh and consider it.",
            questions:[
                {
...
function getQuestion(){
    ...
    conversation.data.forEach(function(content, index) {
       ...
       var parts = content.description.split(/(?=W:|M:)/);
        var formattedConversation = parts.join("<br>");
        description.innerHTML = formattedConversation;
