...
@Controller
@RequestMapping("/client/self-learning/grammar")
public class NguPhapController {
    ...
    public String pageNews(Model model, @RequestParam(value = "page",defaultValue = "1",required = false) Integer page){
        ...
        Page<SelfLearningDto> selfLearningDtos = selfLearningService.getAll(TypeExercise.TUHOC_NGUPHAP.getValue(),page);
        model.addAttribute("selfLearningDtos",selfLearningDtos);
        model.addAttribute("page",page);
        return "/tu-hoc/self-learning-grammar";
    }
    ...
    public String pageNews(@PathVariable("id") Integer id, Model model){
        ...
        model.addAttribute("selfLearningDtoOthers",selfLearningService.getLearningOther(TypeExercise.TUHOC_NGUPHAP.getValue(), id));
        ...
        return "/tu-hoc/detail-self-learning-grammar";
    }
}
