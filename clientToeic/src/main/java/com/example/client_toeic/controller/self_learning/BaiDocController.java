...
@Controller
@RequestMapping("/client/self-learning/reading")
public class BaiDocController {
    ...
    public String pageNews(Model model, @RequestParam(value = "page",defaultValue = "1",required = false) Integer page){
        ...
        Page<SelfLearningDto> selfLearningDtos = selfLearningService.getAll(TypeExercise.TUHOC_BAIDOC.getValue(),page);
        model.addAttribute("selfLearningDtos",selfLearningDtos);
        model.addAttribute("page",page);
        return "/tu-hoc/self-learning-reading";
    }
    ...
    public String pageNews(@PathVariable("id") Integer id, Model model){
        ...
        model.addAttribute("selfLearningDtoOthers",selfLearningService.getLearningOther(TypeExercise.TUHOC_BAIDOC.getValue(), id));
        ...
        return "/tu-hoc/detail-self-learning-reading";
    }
}
